...
## Dataset[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/cDnlIYNC)
# P1: Data Detective

## Summary
This project loads a text file from The Green Mile by Stephen King, cleans it up, breaks it into words, and counts how often each word shows up. It then prints the top N most frequent words and finds any palindrome words in the text.
...
- Report one extra insight (palindrome words found in the text)
...
For the extra insight I went with palindrome detection — words that read the same forwards and backwards like "level" or "noon". The check itself is simple, word == word[::-1], but it produces genuinely surprising results in a narrative text. I filtered out single characters since those are trivially palindromes and not interesting.
